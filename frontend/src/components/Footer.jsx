...
import { PawPrint, Mail, Phone, MessageCircle, Heart } from 'lucide-react';
  ...
  return (
    <footer className="footer-container">
      <div className="footer-content">
        ...
        <div className="footer-brand footer-esconder desliza-esquerda">
          <div className="footer-logo">
            <span className="footer-logo-icone"><PawPrint size={22} /></span>
        ...
        <div className="footer-contact footer-esconder atraso-2">
          ...
          <ul>
            <li><a href="mailto:veterinaria@unifor.br"><Mail size={16} /> veterinaria@unifor.br</a></li>
            <li><a href="tel:+5585999999999"><Phone size={16} /> (85) 9999-9999</a></li>
            <li><a href="https://wa.me/5585999999999" target="_blank" rel="noreferrer"><MessageCircle size={16} /> WhatsApp</a></li>
          </ul>
        </div>
      ...
      <div className="footer-bottom">
        <p>© 2026 Resgatinhos Unifor. Desenvolvido com <Heart size={14} fill="currentColor" className="footer-heart" /> para os felinos.</p>
      </div>
    </footer>
  );
};
